  ...
  if (loading) {
    return (
      <div className="w-full h-[300px] flex items-center justify-center">
        <span className="text-xl text-[#8b2727] font-medium">Loading amazing products...</span>
      </div>
    );
  }
      ...
      <div className="bg-white shadow-sm border-b border-[#d2af6f]/30">
        <div className="container mx-auto max-w-7xl px-4 py-3">
          <nav className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span className="text-[#8b2727] font-medium">Products</span>
          </nav>
        </div>
      </div>
          ...
          {showFilters && (
            <div className="mt-6 pt-6 border-t border-[#d2af6f]/20">
              ...
              <div className="flex justify-between items-center mt-4">
                ...
                <span className="text-gray-600">{filteredData.length} products found</span>
              </div>
            </div>
          )}
        </div>
              ...
              <div className={`${viewMode === "list" ? "flex-1" : ""}`}>
                <div className="flex items-start justify-between mb-2">
                  ...
                  <div className="flex items-center bg-[#f8f3e9] px-2 py-1 rounded-full">
                    <Star className="w-4 h-4 text-[#8b2727]" />
                ...
                <div className="flex items-center justify-between mb-4">
                  <span className="text-xs text-[#8b2727] bg-[#f8f3e9] px-3 py-1 rounded-full font-medium">{product.category}</span>
                </div>
              </div>
            </div>
          ))}
